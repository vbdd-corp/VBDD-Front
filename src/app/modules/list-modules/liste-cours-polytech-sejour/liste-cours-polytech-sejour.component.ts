...
@Component({
  selector: 'app-liste-cours-polytech-sejour',
  templateUrl: './liste-cours-polytech-sejour.component.html',
  styleUrls: ['./liste-cours-polytech-sejour.component.css']
})
export class ListeCoursPolytechSejourComponent implements OnInit {
  listeCoursPolytechForm: FormGroup;
  @Input() module: Module;
  ...
  get f() {
    return this.listeCoursPolytechForm.controls;
  }
  ...
  ngOnInit() {
    this.listeCoursPolytechForm = this.formBuilder.group({
  ...
  setAllInputToNull() {
    for (let i = 1; i <= 12; i++) {
      this.listeCoursPolytechForm.get(this.activeTab + 'codeCours' + i).setValue('');
    }
    for (let i = 1; i <= 12; i++) {
      this.listeCoursPolytechForm.controls[this.activeTab + 'titreCours' + i].setValue('');
    }
    for (let i = 1; i <= 12; i++) {
      this.listeCoursPolytechForm.controls[this.activeTab + 'nombreCredits' + i].setValue('');
    }
  }
  ...
  fillInputs() {
    if (this.module.infos) {
      for (let i = 1; i <= 12; i++) {
        this.listeCoursPolytechForm.get('s1codeCours' + i).setValue(this.module.infos.s1['codeCours' + i]);
        this.listeCoursPolytechForm.get('s2codeCours' + i).setValue(this.module.infos.s2['codeCours' + i]);
      }
      for (let i = 1; i <= 12; i++) {
        this.listeCoursPolytechForm.controls['s1titreCours' + i].setValue(this.module.infos.s1['titreCours' + i]);
        this.listeCoursPolytechForm.controls['s2titreCours' + i].setValue(this.module.infos.s2['titreCours' + i]);
      }
      for (let i = 1; i <= 12; i++) {
        this.listeCoursPolytechForm.controls['s1nombreCredits' + i].setValue(this.module.infos.s1['nombreCredits' + i]);
        this.listeCoursPolytechForm.controls['s2nombreCredits' + i].setValue(this.module.infos.s2['nombreCredits' + i]);
      }
    }
  }
